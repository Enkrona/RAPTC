<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUserReport.aspx.cs" Inherits="WebApplication1.AdminUserReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="button_generate" class="button button2" runat="server" OnClick="Button2_Clickk" style="font-family: 'Open Sans', sans-serif;" Text="Generate Report" />
        <div id="button">
        </div>
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button1" class="button button2" runat="server" Text="Back" color="white" style="font-family: 'Open Sans', sans-serif;" OnClick="Button1_Clickk"/>
        </p>
    </form>
</body>
</html>
