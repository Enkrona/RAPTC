...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="button_generate" runat="server" OnClick="Button2_Clickk" Text="Generate Reports" />
        <div id="button">
        </div>
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Back" OnClick="Button1_Clickk"/>
        </p>
    </form>
</body>
</html>
